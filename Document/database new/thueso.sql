...
--
-- Host: 127.0.0.1
-- Generation Time: May 30, 2019 at 03:51 PM
...
CREATE TABLE `account_member` (
  ...
  `acc_mem_name` varchar(100) COLLATE utf8_vietnamese_ci DEFAULT NULL,
  `acc_mem_password` varchar(100) COLLATE utf8_vietnamese_ci DEFAULT NULL,
  `acc_id` int(11) NOT NULL,
  ...
  `mobile_phone` varchar(20) COLLATE utf8_vietnamese_ci DEFAULT NULL
...
CREATE TABLE `company_information` (
  ...
  `comp_city` varchar(400) CHARACTER SET utf8 COLLATE utf8_vietnamese_ci DEFAULT NULL,
