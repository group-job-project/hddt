...
BEGIN
	SELECT DISTINCT MENU.menu_id, MENU.alias, MENU.menu_link, MENU.menu_parameter, MENU.menu_tooltip,
		MENU.icon,
        IFNULL(SUB_MENU.sub_menu_name, "") AS sub_menu_name, IFNULL(SUB_MENU.sub_menu_link, "") AS sub_menu_link, IFNULL(SUB_MENU.sub_menu_parameter, "") AS sub_menu_parameter, IFNULL(SUB_MENU.icon, "") AS icon,
